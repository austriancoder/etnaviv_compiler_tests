...
DCL ADDR[0]
  ...
  2: MOV_SAT OUT[1].x, CONST[ADDR[0].x+1]
  3: ARL ADDR[0].x, CONST[4].yyyy
  4: MOV_SAT OUT[1].y, CONST[ADDR[0].x+1]
  5: ARL ADDR[0].x, CONST[4].zzzz
  6: MOV_SAT OUT[1].z, CONST[ADDR[0].x+1]
  7: ARL ADDR[0].x, CONST[4].wwww
  8: MOV_SAT OUT[1].w, CONST[ADDR[0].x+1]
  9: END
...
0002: 00811809 00000000 00000000 22390018  MOV.SAT t1.x___, void, void, u1[a.x]
...
0005: 01011809 00000000 00000000 22390018  MOV.SAT t1._y__, void, void, u1[a.x]
...
0008: 02011809 00000000 00000000 22390018  MOV.SAT t1.__z_, void, void, u1[a.x]
...
0011: 04011809 00000000 00000000 22390018  MOV.SAT t1.___w, void, void, u1[a.x]
num loops: 0
num temps: 3
num const: 20
immediates:
