...
DCL TEMP[0], LOCAL
  ...
  2: ADD TEMP[0], TEMP[0], CONST[0]
  3: MUL TEMP[0], TEMP[0], CONST[1]
  4: MOV OUT[0], TEMP[0]
  5: END
...
0002: 07811001 39001800 00000000 20390008  ADD t1, t1, void, u0
0003: 07811003 39001800 01c800c0 00000002  MUL t1, t1, u1, void
num loops: 0
num temps: 2
num const: 8
immediates:
