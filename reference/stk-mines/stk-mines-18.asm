...
IMM[0] FLT32 {    0.5000,     0.0000,     1.0000,     0.0000}
 ...
 30: DP3 TEMP[1], TEMP[0], TEMP[5]
 31: ADD TEMP[1], TEMP[1], TEMP[1]
 32: MAD TEMP[2], -TEMP[1], TEMP[0], TEMP[5]
 33: ADD TEMP[1], TEMP[2], IMM[0].yyzy
 34: DP3 TEMP[1], TEMP[1], TEMP[1]
 35: RSQ TEMP[1], |TEMP[1]|
 36: MUL TEMP[4], TEMP[1], IMM[0].xxxx
 37: MAD TEMP[8].xy, TEMP[2], TEMP[4], IMM[0].xxxx
 38: MOV TEMP[8].zw, IN[3]
 39: MUL TEMP[1], TEMP[8].xxxx, CONST[21]
 40: MAD TEMP[1], TEMP[8].yyyy, CONST[22], TEMP[1]
 41: MAD TEMP[1], TEMP[8].zzzz, CONST[23], TEMP[1]
 42: MAD OUT[2], TEMP[8].wwww, CONST[24], TEMP[1]
 43: END


TGSI asm error: Unknown opcode [31 : 7] 
etnaviv_compiler: could not parse `tgsi/stk-mines/stk-mines-18.tgsi'
