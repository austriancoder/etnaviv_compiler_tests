...
DCL OUT[0], COLOR
IMM[0] FLT32 {    0.6500,     0.9000,     0.0000,     8.0000}
IMM[1] FLT32 {    0.0000,     1.0000,   128.0000,     0.0000}
DCL TEMP[0]
  0: MAX TEMP[0].xy, IMM[0].xyxx, IMM[1].xxxx
  1: CLAMP TEMP[0].z, IMM[0].xxwx, -IMM[1].xxzx, IMM[1].xxzx
...
etnaviv_compiler: could not parse `tgsi/fragProg1/fragProg1-25.tgsi'
