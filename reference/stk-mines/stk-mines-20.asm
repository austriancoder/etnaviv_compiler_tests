...
IMM[0] FLT32 {    0.0000,     1.0000,     0.0000,     0.0000}
 ...
 32: MUL TEMP[8], IN[3].xxxx, CONST[20]
 33: MAD TEMP[8], IN[3].yyyy, CONST[21], TEMP[8]
 34: MAD TEMP[8], IN[3].zzzz, CONST[22], TEMP[8]
 35: MAD OUT[3], IN[3].wwww, CONST[23], TEMP[8]
 36: END


TGSI asm error: Unknown opcode [33 : 7] 
etnaviv_compiler: could not parse `tgsi/stk-mines/stk-mines-20.tgsi'
