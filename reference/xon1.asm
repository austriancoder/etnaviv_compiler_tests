...
IMM[1] FLT32 {    1.0000,     0.2500,     0.0000,     0.0000}
 ...
 13: TEX TEMP[4].xyz, TEMP[4], SAMP[4], 2D
 ...
 23: MUL TEMP[5].xyz, TEMP[3].xyzz, CONST[7].xyzz
 ...
 33: MAD TEMP[3].x, CONST[8].xxxx, TEMP[3].wwww, IMM[1].xxxx
 34: POW TEMP[3].x, TEMP[6].xxxx, TEMP[3].xxxx
 35: MUL TEMP[6].xyz, TEMP[0].xyzz, CONST[6].xyzz
...
0006: 03861001 29006800 00000000 200000a8  ADD t6.xyz_, t6.xyzz, void, u10.xxxx
...
0013: 23881018 39008f20 00000000 00000000  TEXLD t8.xyz_, tex4, t8, void, void
0014: 03881002 29008800 00aa0540 202a80aa  MAD t8.xyz_, t8.xyzz, u10.yyyy, u10.zzzz
...
0023: 03831003 29007800 014803c0 00000002  MUL t3.xyz_, t7.xyzz, u7.xyzz, void
...
0026: 03841003 1540a800 01480250 00000000  MUL t4.xyz_, u10.yyyy, t4.xyzz, void
...
0032: 0084108f 40004800 01fe0540 0040004a  SELECT.LT t4.x___, -t4.xxxx, u10.wwww, -t4.xxxx
0033: 078b1009 00000000 00000000 200000b8  MOV t11, void, void, u11.xxxx
0034: 00871002 00008800 01fe03d0 003900b8  MAD t7.x___, u8.xxxx, t7.wwww, t11
...
0038: 03841003 2900a800 01480340 00000002  MUL t4.xyz_, t10.xyzz, u6.xyzz, void
0039: 00861005 29006800 01480440 00000000  DP3 t6.x___, t6.xyzz, t8.xyzz, void
0040: 0086108f 00006800 01fe0540 0000006a  SELECT.LT t6.x___, t6.xxxx, u10.wwww, t6.xxxx
...
0044: 1b871018 39007f20 00000000 00000000  TEXLD t7.xyz_, tex3, t7, void, void
0045: 0088108f 1540b800 01540450 201540b8  SELECT.LT t8.x___, u11.yyyy, t8.zzzz, u11.yyyy
...
0048: 038a1003 2900a800 014802c0 00000002  MUL t10.xyz_, t10.xyzz, u5.xyzz, void
...
immediates:
 ...
 [10].z = -1.000000 (0xbf800000)
 [10].w = 0.000000 (0x00000000)
 [11].x = 1.000000 (0x3f800000)
 [11].y = 0.250000 (0x3e800000)
