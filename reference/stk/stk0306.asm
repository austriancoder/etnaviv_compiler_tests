...
DCL TEMP[0..8]
 ...
 30: MUL TEMP[8], IN[3].xxxx, CONST[19]
 31: MAD TEMP[8], IN[3].yyyy, CONST[20], TEMP[8]
 32: MAD TEMP[8], IN[3].zzzz, CONST[21], TEMP[8]
 33: MAD OUT[2], IN[3].wwww, CONST[22], TEMP[8]
 34: END



TGSI asm error: Unknown opcode [29 : 7] 
etnaviv_compiler: could not parse `tgsi/stk/stk0306.tgsi'
